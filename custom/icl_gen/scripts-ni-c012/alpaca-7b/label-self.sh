...
do
    ...
    CUDA_VISIBLE_DEVICES=${CVD} python3 $SRC_DIR/label_param.py \
        ...
        --ckpt_dir $REPO_ROOT_DIR/saves/ni-c012/ALPACA-7B/lora/${CATE}/bs32x1x1-3ep-bf16 \
        ...
        --output_path $REPO_ROOT_DIR/data/ni-cus0.12/genearated-icl-naive-kmeans20-self/alpaca-7b/${CATE}/$CUR_CATE.train.smp001.2shot.smp3.rp1.2.json \
        --do_sample False \
        --max_length 2048 \
        --template alpaca
done
