...
def init_adapter(
    ...
    if finetuning_args.finetuning_type == "lora":
        ...
        if model_args.checkpoint_dir is not None:
            assert os.path.exists(os.path.join(model_args.checkpoint_dir[0], WEIGHTS_NAME)) or os.path.exists(os.path.join(model_args.checkpoint_dir[0], SAFETENSORS_WEIGHTS_NAME)), \
