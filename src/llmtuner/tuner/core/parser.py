...
def get_train_args(
    ...
    if general_args.stage not in ["sft", "sftrp", "sftreg"] and training_args.predict_with_generate:
        raise ValueError("`predict_with_generate` cannot be set as True except SFT.")

    if general_args.stage in ["sft", "sftrp", "sftreg"] and training_args.do_predict and not training_args.predict_with_generate:
    ...
    if (
        ...
        if general_args.stage != "sftreg" and last_checkpoint is None and len(os.listdir(training_args.output_dir)) > 0:
