...
CKPT_DIR=$REPO_ROOT_DIR/saves/ni-c012/ALPACA-7B/lora/cl_queue_alpaca01_qa/bs32x1x1-3ep-bf16
...
do
    ...
    CKPT_DIR=$REPO_ROOT_DIR/saves/ni-c012/ALPACA-7B/lora/cl_queue_alpaca01_rp${SMP_RATIO}_${CUR_CATE}/bs32x1x1-3ep-bf16
    if [ -d $CKPT_DIR ]; then
        echo File $CKPT_DIR exists.
        continue
    fi

    DATASETS="alpaca_en_smp01,ni_c012_${CUR_CATE}_train"
...
do
    ...
    then
        ...
        CKPT_DIR=$REPO_ROOT_DIR/saves/ni-c012/ALPACA-7B/lora/cl_queue_alpaca01_${CUR_CATE}/bs32x1x1-3ep-bf16
    fi
