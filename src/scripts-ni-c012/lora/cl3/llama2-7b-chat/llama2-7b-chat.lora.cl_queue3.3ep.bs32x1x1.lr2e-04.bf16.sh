...
do
    ...
    CKPT_DIR=$REPO_ROOT_DIR/saves/ni-c012/LLAMA2-7B-Chat/lora/cl_queue3_${CUR_CATE}/bs32x1x1-3ep-bf16
    if [ -d $CKPT_DIR ]; then
...
do
    ...
    do
        echo $CUR_CATE $CUR_CATE_Y
        echo $CKPT_DIR"/ni_c012_${CUR_CATE_Y}_eval"
