...
CATE_LIST=("sum" "qg" "trans" "qa" "sa") # "dsg" "expl" "para" "pe" "pos")
...
do
    ...
    then
        ...
        CKPT_DIR=$REPO_ROOT_DIR/saves/ni-c012/LLAMA2-7B-Chat/lora/cl_queue3_iclgen_self_${CUR_CATE}/bs32x1x1-3ep-bf16
        echo $CKPT_DIR
        ...
        if [ -d $CKPT_DIR ]; then
            ...
            do
                ...
                then
                    ...
                    DATASETS="$DATASETS,ni_c012_icl_gen_km20_self_cl_queue3_llama2_7b_chat_${PREV_CATE}"
                fi
            done
    ...
    OUTPUT_PATH=$REPO_ROOT_DIR"/data/ni-cus0.12/genearated-icl-naive-kmeans20-self/llama2-7b-chat/cl_queue3/$CUR_CATE.train.smp001.2shot.smp3.rp1.2.json"
