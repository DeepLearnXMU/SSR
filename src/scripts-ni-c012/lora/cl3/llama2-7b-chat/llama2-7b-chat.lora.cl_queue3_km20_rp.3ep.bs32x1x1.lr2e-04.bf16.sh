...
do
    ...
    CKPT_DIR=$REPO_ROOT_DIR/saves/ni-c012/LLAMA2-7B-Chat/lora/cl_queue3_km20_rp${SMP_RATIO}_${CUR_CATE}/bs32x1x1-3ep-bf16
    if [ -d $CKPT_DIR ]; then
    ...
    do
        ...
        then
            ...
            DATASETS="$DATASETS,ni_c012_${PREV_CATE}_train_km20_smp${SMP_RATIO}"
        fi
    done
